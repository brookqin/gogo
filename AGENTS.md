...
- Add Launcher opens a new editor directly, without a submenu. Launcher rows are reordered by dragging and edited by clicking; do not add per-row action menus.
